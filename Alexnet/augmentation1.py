...
def main():
    ...
    # Create data loader
    trainDataLoader_1 = torch.utils.data.DataLoader(train_images_1,batch_size=32,num_workers=2, shuffle=True)
    testDataLoader_1 = torch.utils.data.DataLoader(test_images_1,batch_size=32,num_workers=2, shuffle=False)
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig("./2GPU_plots/aug1_%s_loss.png" % args.optimizer)
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig("./2GPU_plots/aug1_%s_accuracy.png" % args.optimizer)
