...
def main():
    ...
    # Create data loader
    trainDataLoader_3 = torch.utils.data.DataLoader(train_images_3,batch_size=32,num_workers=2, shuffle=True)
    testDataLoader_3 = torch.utils.data.DataLoader(test_images_3,batch_size=32,num_workers=2, shuffle=False)
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig("./2GPU_plots/aug3_%s_loss.png" % args.optimizer)
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig("./2GPU_plots/aug3_%s_accuracy.png" % args.optimizer)
