...
def main():
    ...
    # Create data loader
    trainDataLoader_4 = torch.utils.data.DataLoader(train_images_4,batch_size=32,num_workers=2, shuffle=True)
    testDataLoader_4 = torch.utils.data.DataLoader(test_images_4,batch_size=32,num_workers=2, shuffle=False)
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig("./2GPU_plots/aug4_%s_loss.png" % args.optimizer)
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig("./2GPU_plots/aug4_%s_accuracy.png" % args.optimizer)
