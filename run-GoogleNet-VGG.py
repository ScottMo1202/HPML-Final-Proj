...
def main():
    ...
    fig.suptitle(args.aug + '_train_test_accuracies_' + args.optimizer + "_" + args.numGPUs + "_" + args.model)
    ...
    fig.suptitle(args.aug + "_train_test_losses_" + args.optimizer + "_" + args.numGPUs + "_" + args.model)
    ax.set_xlabel("Epoch")
